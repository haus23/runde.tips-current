    ...
    "
      >
        <div className="flex flex-col items-center gap-y-6 w-48 sm:w-64">
          ...
          <svg className="fill-current" viewBox="0 0 3160 2610">
            <g>
          ...
          <div className="shim relative overflow-hidden w-full h-2 bg-gray-200 rounded">
            <div className="w-full h-full bg-indigo-500 rounded"></div>
          </div>
        </div>
      </div>
    </Transition>
