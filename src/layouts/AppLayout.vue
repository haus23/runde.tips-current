  ...
  >
    <div class="flex flex-grow items-center">
      <div class="flex flex-grow">
        <a href="/" class="font-medium flex gap-x-2 text-black dark:text-white">
          <img
    ...
    <div :class="{ hidden: !open }" class="absolute top-0 inset-x-0 p-2">
      ...
      >
        <div class="flex px-2 pt-2">
          <div class="flex flex-grow">
            <a href="/" class="flex gap-x-2 text-black dark:text-white font-medium">
              <img
                class="w-8 h-8 dark:hidden"
                src="../assets/logo-dark.svg"
                alt="Logo"
        ...
        <div class="pt-2">
          <div class="flex flex-col px-2 py-2 space-y-1">
            <a class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800" href="/tabelle">Tabelle</a>
            <a class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800" href="/spieler">Spieler</a>
            <a class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800" href="/spiele">Spiele</a>
          </div>
          <div class="rounded-b-lg">
            <a class="rounded-b-lg font-medium py-1 block w-full text-center bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700" href="/login">Log In</a>
          </div>
        </div>
      </div>
    </div>
