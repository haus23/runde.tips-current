        ...
        <div class="flex justify-between h-12">
          <div class="flex">
            <div class="flex-shrink-0 flex items-center">
              <router-link to="/" class="flex items-center gap-x-2">
                <svg class="fill-current h-8" viewBox="0 0 3160 2610">
                  <g>
                    <path
                ...
                <span class="font-medium">runde.tips</span>
              </router-link>
            </div>
            <div class="hidden sm:-my-px sm:ml-6 sm:flex sm:gap-x-4">
              <topnav-link to="/tabelle">Tabelle</topnav-link>
              <topnav-link to="/spieler">Spieler</topnav-link>
              <topnav-link to="/spiele">Spiele</topnav-link>
            </div>
          </div>
          <div class="hidden sm:ml-6 sm:flex sm:items-center sm:gap-x-4">
            <button
              ...
              "
            >
              <span class="sr-only">Umschalten zwischen dunklen und hellen Farben</span>
